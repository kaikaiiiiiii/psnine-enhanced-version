    ...
    */
    ...
    if ((/\/psnid\/[A-Za-z0-9_-]+\/?$/.test(window.location.href)
      ...
      if (settings.platinumGlow) {
        ...
        GM_addStyle('.platinum-sweep::before{content:"";position:absolute;top:0;left:0;right:0;bottom:0;background:linear-gradient(45deg,rgba(0, 102, 255, 0.3) 0%, rgba(233, 242, 255, 0.2) 80%, rgba(255, 255, 255, 0.6) 85%, rgba(233, 242, 255, 0.2) 90%, rgba(0, 102, 255, 0.3) 100%);pointer-events:none;}');
